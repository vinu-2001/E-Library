...
<span>In order to connect the server and your clint machine you need to change the Connection string of the Database which is present in the Web.config file change the  </span>
