...
namespace E_Library
{
    public partial class adminbookinventory : System.Web.UI.Page
    {
        ...
        protected void Button3_Click(object sender, EventArgs e)
        {
           ...
           {
            Response.Write("<script>alert('Book already exist. Try some other Book ID and Book Name.');</script>");
           }
            else
            {
                addNewBook();
            ...
            if (checkIfBookExists())
            {
                try
                {
                    ...
                    SqlCommand cmd = new SqlCommand("UPDATE book_master_tbl SET book_name=@book_name, genre=@genre," +
                        "author_name=@author_name, publisher_name=@publisher_name, publish_date=@publish_date," +
        ...
        void getBookByID()
        {
            try
            {
                ...
                if (dt.Rows.Count >= 1)
                {
                    ...
                    TextBox4.Text = dt.Rows[0]["publish_date"].ToString();
