<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="viewbook.aspx.cs" Inherits="E_Library.viewbook" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container">
          ...
          <div class="row">
              <div class="col-sm-12">
                  <center><h3>Boook List</h3></center>
                  <div class="row">
