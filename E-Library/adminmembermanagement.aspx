                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col">
                                <center>
                                    <img width="100px" src="imgs/generaluser.png" /></center>
                            </div>
                        </div>
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        <asp:TextBox Class="form-control mr-1" ID="TextBox1" runat="server" placeholder="ID"></asp:TextBox>
                        ...
                        <div class="row">
                               ...
                               <div class="col-md-3">
                                <label>DOB</label>
                                <div class="form-group">
                                    <asp:TextBox Class="form-control" ID="TextBox8" runat="server" placeholder="DOB" ReadOnly="True"></asp:TextBox>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <asp:TextBox Class="form-control" ID="TextBox5" runat="server" placeholder="Contact No." ReadOnly="True"></asp:TextBox>
                                </div>
                            </div>
                            ...
                            <div class="col-md-5">
                                ...
                                <div class="form-group">
                                    <asp:TextBox Class="form-control" ID="TextBox6" runat="server" placeholder="Email ID" ReadOnly="true"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                ...
                                <div class="form-group">
                                    <asp:TextBox Class="form-control" ID="TextBox3" runat="server" placeholder="Full Postal Address" ReadOnly="True" TextMode="MultiLine"></asp:TextBox>
                                </div>
                            </div>
