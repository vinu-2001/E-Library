<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="sellbook.aspx.cs" Inherits="E_Library.sellbook" %>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col">
                                <center>
                                    <img id="imgview" width="100px" height="150px" src="imgs/sellbook.png"/>
                                </center>
                            </div>
                        </div>
                           ...
                           <div class="row">
                            <div class="col">
                                ...
                                <div class="form-group">
                                    ...
                                    <asp:TextBox Class="form-control" ID="TextBox5" runat="server" placeholder="+91" TextMode="Number"></asp:TextBox>
                                    <label>UPIs</label>
                                    <asp:TextBox Class="form-control" ID="TextBox6" runat="server" placeholder="Gpay,AmazonPay,PayTM,etc..."></asp:TextBox>
                                </div>
                            </div>
                        </div>
